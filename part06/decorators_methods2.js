...
{
    var myCar = function () {
        var _classDecorators = [changeDoorStatus7(false), changeAmountOfFuel7(95)];
        ...
        (function () {
            ...
            __esDecorate(_classThis, null, _isOpen_decorators, { kind: "method", name: "isOpen", static: false, private: false, access: { has: function (obj) { return "isOpen" in obj; }, get: function (obj) { return obj.isOpen; } } }, null, _instanceExtraInitializers);
    ...
    // 	};
    // }
    function checkAmountOfFuel7(target, context) {
        return function () {
            var args = [];
    ...
    function changeDoorStatus7(status) {
    ...
    function changeAmountOfFuel7(amount) {
